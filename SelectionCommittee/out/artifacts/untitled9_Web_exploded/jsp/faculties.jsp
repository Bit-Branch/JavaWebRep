...
<section class="popular-courses-area section-padding-100" data-pg-collapsed>
    <div class="container">
        <div class="row">
            ...
            <c:if test="${faculties.size() == 0}">
                <h1><fmt:message key="header.thereAreNoFaculties" bundle="${lang}"/></h1>
            </c:if>
                    ...
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="${ pageContext.servletContext.contextPath }/choose_faculty?id=${faculty.getId()}&command=choose_faculty" class="free"><fmt:message key="label.choose" bundle="${lang}"/></a>
                            </div>
                        </div>
                    </div>
                </div>
