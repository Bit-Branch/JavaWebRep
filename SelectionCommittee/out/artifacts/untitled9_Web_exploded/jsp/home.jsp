...
<!-- ##### Hero Area Start ##### -->
<section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(${ pageContext.servletContext.contextPath }/img/bg-img/bg1.jpg);">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <!-- Hero Content -->
                <div class="hero-content text-center">
                    <h2><fmt:message key="header.letsStudyTogether" bundle="${lang}"/></h2>
                    <a href="${ pageContext.servletContext.contextPath }/show_faculties?command=show_faculties" class="btn clever-btn"><fmt:message key="label.enroll" bundle="${lang}"/></a>
                </div>
            </div>
        </div>
    </div>
...
<%--                    <div class="icon">--%>
<%--                        <img src="${ pageContext.servletContext.contextPath }/img/core-img/docs.png" alt="">--%>
<%--                    </div>--%>
...
<%--                    <div class="icon">--%>
<%--                        <img src="${ pageContext.servletContext.contextPath }/img/core-img/star.png" alt="">--%>
<%--                    </div>--%>
...
<%--                    <div class="icon">--%>
<%--                        <img src="${ pageContext.servletContext.contextPath }/img/core-img/events.png" alt="">--%>
<%--                    </div>--%>
...
<%--                    <div class="icon">--%>
<%--                        <img src="${ pageContext.servletContext.contextPath }/img/core-img/earth.png" alt="">--%>
<%--                    </div>--%>
...
<%--<section class="popular-courses-area section-padding-100-0" style="background-image: url(${ pageContext.servletContext.contextPath }/img/core-img/texture.png);">--%>
<%--    <div class="container">--%>
<%--        <div class="row">--%>
<%--            <div class="col-12">--%>
...
<%--                    <img src="${ pageContext.servletContext.contextPath }/img/bg-img/c3.jpg" alt="">--%>
<%--                    <!-- Course Content -->--%>
<%--                    <div class="course-content">--%>
...
<section class="best-tutors-area section-padding-100">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-heading">
                    <h3><fmt:message key="header.ourStaff" bundle="${lang}"/></h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="tutors-slide owl-carousel wow fadeInUp" data-wow-delay="250ms">
                    ...
                    <div class="single-tutors-slides">
                        <!-- Tutor Thumbnail -->
                        <div class="tutor-thumbnail">
                            <img src="${ pageContext.servletContext.contextPath }/img/bg-img/t5.png" alt="">
                        </div>
                        <!-- Tutor Information -->
                        <div class="tutor-information text-center">
                            <h5>Alex Parker</h5>
...
<!-- ##### Register Now Start ##### -->
<%--<section class="register-now section-padding-100-0 d-flex justify-content-between align-items-center" style="background-image: url(${ pageContext.servletContext.contextPath }/img/core-img/texture.png);">--%>
...
<section class="upcoming-events section-padding-100-0">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-heading">
                    <h3><fmt:message key="header.upcomingEvents" bundle="${lang}"/></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                    ...
                    <div class="events-thumb">
                        <img src="${ pageContext.servletContext.contextPath }/img/bg-img/e1.jpg" alt="">
                        <h6 class="event-date">August 26</h6>
                        <h4 class="event-title"><fmt:message key="header.networkingDay" bundle="${lang}"/></h4>
                    </div>
                    <!-- Date & Fee -->
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="500ms">
                    <!-- Events Thumb -->
                    <div class="events-thumb">
                        <img src="${ pageContext.servletContext.contextPath }/img/bg-img/e2.jpg" alt="">
                        <h6 class="event-date">August 7</h6>
                        <h4 class="event-title"><fmt:message key="header.openDoorsDay" bundle="${lang}"/></h4>
                    </div>
                    <!-- Date & Fee -->
                    <div class="date-fee d-flex justify-content-between">
                        <div class="date">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="750ms">
                    <!-- Events Thumb -->
                    <div class="events-thumb">
                        <img src="${ pageContext.servletContext.contextPath }/img/bg-img/e3.jpg" alt="">
                        <h6 class="event-date">August 3</h6>
                        <h4 class="event-title"><fmt:message key="header.creativeLeadership" bundle="${lang}"/></h4>
                    </div>
                    <!-- Date & Fee -->
                    <div class="date-fee d-flex justify-content-between">
                        <div class="date">
...
<section class="blog-area section-padding-100-0">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-heading">
                    <h3><fmt:message key="header.ourLections" bundle="${lang}"/></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="250ms">
                    <img src="${ pageContext.servletContext.contextPath }/img/blog-img/1.jpg" alt="">
                    <!-- Blog Content -->
                    <div class="blog-content">
                        <a href="#" class="blog-headline">
                            <h4><fmt:message key="header.englishGrammar" bundle="${lang}"/></h4>
                        </a>
                        <div class="meta d-flex align-items-center">
                            <a href="#">Sarah Parker</a>
                            <span><i class="fa fa-circle" aria-hidden="true"></i></span>
            ...
            <div class="col-12 col-md-6">
                <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                    <img src="${ pageContext.servletContext.contextPath }/img/blog-img/2.jpg" alt="">
                    <!-- Blog Content -->
                    <div class="blog-content">
                        <a href="#" class="blog-headline">
                            <h4><fmt:message key="header.russianGrammar" bundle="${lang}"/></h4>
                        </a>
                        <div class="meta d-flex align-items-center">
                            <a href="#">Sarah Parker</a>
                            <span><i class="fa fa-circle" aria-hidden="true"></i></span>
