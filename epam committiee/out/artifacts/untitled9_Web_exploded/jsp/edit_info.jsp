                                ...
                                <div class="page-content">
                                    <form>
                                        <div class="forms" data-pg-collapsed>
                                            ...
                                            <form action="${ pageContext.servletContext.contextPath }/editInfo" method="POST">
                                                <input type="hidden" name="command" value="sign_up"/><br/>
                                                ...
                                                <div class="row" data-pg-collapsed>
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <h5><fmt:message key="label.photo" bundle="${lang}"/></h5>
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="#{user.getPatronymic()}"
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="#{user.getPassportNumber()}"
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="${address.getLocality()}"
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="${address.getBuilding()}"
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="${address.getZipCode()}"
                                                    ...
                                                    <div class="col-12 col-lg-6" data-pg-collapsed>
                                                        <div class="form-group">
                                                            <input value="${account.getPassword()}"
